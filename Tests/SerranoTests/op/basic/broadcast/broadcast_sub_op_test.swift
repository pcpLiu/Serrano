...
class OperatorDelegateConvBroadcastSubOp: OperatorDelegateConvBroadcastArithmeticOp {
...
class BroadcastSubOpTest: XCTestCase {
	...
	func test() {
		let testCase = BroadcastArithmeticOpTest<BroadcastSubOperator, OperatorDelegateConvBroadcastSubOp>()
		testCase.testAll()
	}
